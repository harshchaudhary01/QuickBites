...
const CategoryCard = ({name,image}) => {
  return (
    <div className='w-30 h-30 md:w-45 md:h-45 rounded-2xl border-2 border-[#ff4d2d] shrink-0 overflow-hidden bg-white shadow-xl shadow-gray-200 hover:shadow-lg transition-shadow relative'>
      ...
      <div className='absolute bottom-0 left-0 w-full bg-[#ffffff96] bg-opacity-95 px-3 py-1 rounded-t-xl text-center text-center shadow font-medium text-gray-800 backdrop-blur'>
        {name}
      </div>
    </div>
  )

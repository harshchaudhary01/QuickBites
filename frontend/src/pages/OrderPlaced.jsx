...
const OrderPlaced = () => {
  ...
  return (
    <div className='min-h-screen bg-[#fff9f6] flex flex-col justify-center items-center px-4 text-center relative overflow-hidden'>
      ...
      <img className='w-40 h-40' src={orderPlaced} alt="Order Placed Animation" />
      ...
      <button onClick={()=>navigate("/my-orders")} className='bg-[#ff4d2d] hover:bg-[#e64526] text-white px-6 py-3 rounded-lg text-lg transition font-semibold'>Back to my Orders</button>
    </div>
  )
}

...
function TrackOrderPage() {
    ...
    return (
        <div className='max-w-4xl mx-auto p-4 flex flex-col gap-6'>
            <div className='relative top-5 left-5 z-10 mb-2.5 cursor-pointer flex items-center gap-4' onClick={() => navigate("/")}>
            ...
            {currentOrder?.shopOrders?.map((shopOrder, index)=>(
                <div className='bg-white p-4 rounded-2xl shadow-md border border-orange-50 space-y-4' key={index}>
                    ...
                    </>:<p className='text-green-600 font-semibold text-lg'>Order Delivered</p>}
